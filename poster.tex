...
% Footer content
\footercontent{
\href{https://github.com/mrislambd/FSU-math-poster-template}{github.com/mrislambd/FSU-math-poster-template} \hfill Unofficial Poster Design\hfill Florida State University Mathematics
}

% Logos (replace with your real paths)
\logoleft{\includegraphics[height=6.5cm]{logo/fsu-logo.png}}
\logoright{\includegraphics[height=7cm]{logo/fsumath.png}}
